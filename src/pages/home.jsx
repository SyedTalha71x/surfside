                    ...
                    <div className="w-full  flex flex-col gap-3 items-center mt-10 sm:mt-14 md:mt-18 lg:mt-24 space-y-10 sm:space-y-14 md:space-y-18 lg:space-y-24">
                        ...
                        >
                            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black text-center">
                                <span className="gradient-title [text-shadow:0_0_20px_rgba(135,136,254,0.5),0_0_40px_rgba(105,108,238,0.3)]">Fast </span>
                                and
                                <span className="gradient-title [text-shadow:0_0_20px_rgba(135,136,254,0.5),0_0_40px_rgba(105,108,238,0.3)]"> Easy</span>
                                <br />
                                Currency Conversion
                            </h1>
                        </motion.div>
                        <div className="flex flex-col gap-5 items-center z-50 ">
                            <motion.p
                                ...
                                className="font-bold text-lg sm:text-2xl md:text-3xl xl:text-4xl text-center">Get real-time rates for fiat and cryptocurrencies. <br /> Compare and convert in seconds</motion.p>
                            <Link
                                to='convert'
                                offset={-120}
                                smooth
